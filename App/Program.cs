...
builder.AddTheWorks(
    new StartupParametersBuilder()
        ...
        .WithAzureAppConfiguration(
            config =>
                config.Connect(
                    builder.Configuration[Constants.AZURE_APPCONFIGURATION_CONNECTION_STRING]
                ),
...
builder.Services.Configure<RedisCacheConfiguration>(
    config =>
        config.ConnectionString = builder.Configuration[Constants.REDIS_CACHE_CONNECTION_STRING]
);
...
builder.Services.AddSingleton<
    Dgmjr.RedisCacheAccessor.Abstractions.IRedisCacheAccessor,
    Dgmjr.RedisCacheAccessor.Core.RedisCacheAccessor
>();
builder.Services.AddSingleton<
    Dgmjr.RedisCacheAccessor.Abstractions.ICacheConnector,
    Dgmjr.RedisCacheAccessor.Core.CacheConnector
>();
